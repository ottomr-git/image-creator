...
產品合成原則：
- 產品的品牌標籤、包裝設計、顏色、材質必須忠實呈現，不可更改、替換或讓字樣消失
- 整體光源、陰影、透視要與場景一致，產品擺放要自然合理，不可有懸浮或剪貼感
- 若構圖需要景深效果，前景或背景的產品可以適度柔焦，這是正常的攝影表現，不必強制所有產品都清晰
- 以「真實商業攝影」的標準來構圖，讓畫面看起來像是專業棚拍而非後製合成
